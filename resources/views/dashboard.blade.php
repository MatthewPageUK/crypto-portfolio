<x-app-layout>
    ...
    <div class="flex flex-wrap">
        <div class="w-1/6 p-6 m-5 bg-white shadow-lg rounded-lg">
            <p>
                <a href="{{ route('addtoken') }}" title="Add a new token" class="text-blue-500 hover:text-blue-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 hover:text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        @foreach ($tokens as $token)
            <div class="w-1/6 p-6 m-5 bg-white shadow-lg rounded-lg text-center">
