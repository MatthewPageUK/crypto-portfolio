    ...
    <div class="flex items-center justify-center mx-12">
        ...
        <div class="flex items-center w-full lg:w-5/6 mt-16 mb-64">
            <div class="flex w-full bg-white py-8 px-24 pb-16 rounded-lg shadow-lg"
                x-data="{ direction: '', price: 0, quantity: 0, profit: 10, loss: 5, token: '', funds: 4528 }"
            ...
            >
                <div class="w-3/4 pr-16">
                    <h1 class="font-bold text-3xl mb-4">Your bot is working... </h1>
                    ...
                    <form method="POST" action="{{ route('token.store') }}">
                        ...
                        History
                            Started date
                            Placed exchnage order - filled

                        <!-- Direction -->
                        <div class="mb-4">

                            <x-label for="bot_direction" value="{{ __('Which way do you think the market is going to move?') }}" />
                            ...
                            >
                                <input name="bot_direction" type="radio" value="up" x-model="direction" class="mr-2">
                            ...
                            >
                                <input name="bot_direction" type="radio" value="down" x-model="direction" class="mr-2">
                        ...
                        <div x-show="direction != ''">
                            ...
                            <!-- Token -->
                            <div class="mb-4">
                                {{-- <x-label for="token_id" value="{{ __('Asset to gamble') }}" /> --}}
                                ...
                                >
                                    ...
                                    @foreach($tokens as $token)
                                        <option x-text="'{{ $token->symbol }}'" value="{{ $token->id }}">{{ $token->symbol }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div x-show="token != ''">
                                ...
                                <div class="mb-4" x-show="direction == 'up'">
                                    <x-label for="bot_buy_price" :value="__('Buy in price')" />

                                    <x-input id="bot_buy_price" class="block mt-1 w-full" type="text" name="bot_buy_price" :value="old('bot_buy_price')" required
                                        x-model="price"
                                    />
                                ...
                                <div x-show="price > 0">
                                    ...
                                    <!-- Quantity -->
                                    <div>
                                        <x-label for="bot_quantity" :value="__('Quantity')" />

                                        <div class="relative">

                                            <x-input id="bot_quantity" class="block mt-1 w-full" type="text" name="bot_quantity" :value="old('bot_quantity')" required x-model="quantity" />

                                            <span class="absolute top-0 right-0 text-xs mt-1 bg-red-500 text-white p-2 rounded-full" x-show="( quantity * price ) > 5250">Insufficient funds on Exchange</span>
                                    ...
                                    <div x-show="quantity > 0">
                                        ...
                                        <!-- Minimum Profit -->
                                        <div class="mt-4" >
                                            <x-label for="bot_profit" value="{{ __('Minimum profit to take') }}" />
                                            ...
                                            <div class="flex space-x-4 items-center">
                                                <input type="range" min="1" max="100" step="1" value="1" class="form-range w-full h-6 p-0 bg-transparent focus:outline-none focus:ring-0 focus:shadow-none"
                                                    id="bot_profit" name="bot_profit" x-model="profit">
                                        ...
                                        <div x-show="profit > 0">
                                            ...
                                            <!-- Stop Loss -->
                                            <div class="mt-4">
                                                <x-label for="bot_loss" value="{{ __('Maximum loss to take') }}" />

                                                <div class="flex space-x-4 items-center">
                                                    <input type="range" min="1" max="100" step="1" value="1" class="form-range w-full h-6 p-0 bg-transparent focus:outline-none focus:ring-0 focus:shadow-none"
                                                        id="bot_loss" name="bot_loss" x-model="loss">
